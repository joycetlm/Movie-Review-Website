...
@section('content')
<?php use Illuminate\Support\Facades\DB;$i=0; $forums = DB::table('forums')->where('tags', 'action')->get(); $forums = json_decode($forums,true);?>
<div class="container">
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="jumbotron">
                  <h1>Welcome to Action Film Forum!</h1>
